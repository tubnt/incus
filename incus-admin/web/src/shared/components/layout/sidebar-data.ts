...
export const sidebarGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "nav.ha", to: "/admin/ha", icon: "Shield", adminOnly: true },
      { key: "nav.storage", to: "/admin/storage", icon: "HardDrive", adminOnly: true },
      { key: "nav.ipPools", to: "/admin/ip-pools", icon: "Globe", adminOnly: true },
      { key: "nav.ipRegistry", to: "/admin/ip-registry", icon: "MapPin", adminOnly: true },
      ...
      { key: "nav.invoices", to: "/admin/invoices", icon: "FileText", adminOnly: true },
      ...
      { key: "nav.nodes", to: "/admin/nodes", icon: "Server", adminOnly: true },
      { key: "nav.nodeOps", to: "/admin/node-ops", icon: "Terminal", adminOnly: true },
      { key: "nav.observability", to: "/admin/observability", icon: "BarChart3", adminOnly: true },
